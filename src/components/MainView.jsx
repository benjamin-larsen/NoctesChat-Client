        ...
        <div style="display: flex; flex-direction: column; height: 100%">
          <div className="channelListContainer">
            ...
            <Tooltip nSlot="show, hide, tempRef">
              <slot name='tooltip'>
                <div style="padding: 6px 8px; background: #2f445a; color: white; border-radius: 6px;">Create new Channel</div>
              </slot>
          ...
          <div className="profileContainer">
            <Tooltip nSlot="show, hide, tempRef" mode="top">
              <slot name='tooltip'>
                <div style="padding: 6px 8px; background: #2f445a; color: white; border-radius: 6px;">Test Tooltip</div>
              </slot>
