    ...
    return <>
      <div className={{
        ...
        <div className="inputContent">
          ...
          <input disabled={props.disabled} onFocus={() => {ctx.isFocused.value = true}} onBlur={() => {ctx.isFocused.value = false}} onClick={(e) => e.stopPropagation()} ref={ctx.inputEl} type={ctx.toggled.value ? null : props.type} tabindex="0" nModel={ctx.model.value} />
        </div>
        {props.type === "password" ?
        <button onClick={(e) => {e.stopPropagation(); ctx.toggled.value = !ctx.toggled.value}} class="inputOptionBtn">
          {ctx.toggled.value ?
